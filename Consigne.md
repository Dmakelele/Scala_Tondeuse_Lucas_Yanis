# Scala_Tondeuse_Lucas_Yanis


Le fichier Input est un fichier texte qui contient en première ligne, les limites de l'espace, puis qui alterne respectivement la postition d'une tondeuse
et ses instructions. 
